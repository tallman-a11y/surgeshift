-- Shift Brain memory layer for AgentShift: cross-session semantic memory.
-- Lets Shift remember how an agent prices, who their sphere is, which scripts land,
-- and how they like to work — across sessions and across the Shift family.
